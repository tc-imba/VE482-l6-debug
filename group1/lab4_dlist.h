...
// members in union share the same space of memory
// give one member a value, other members can also access it with their own data types
// Ad: save memory
// Disad: may cause misuse and hard to debug

typedef void* dlist;
// just an interface, realize the double-list in .c
// when used, cast the dlist into double-list
// user only knows the dlist, doesn't concern the actual data type
